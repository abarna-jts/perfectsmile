    ...
    <div class="content">
        ...
        <p>Perfect Smile</p>
         <a href="https://www.facebook.com"> <i class="fa-brands fa-facebook-f"></i>  </a>
            ...
            <a href="https://wa.me/7305686253"><i class="fa-brands fa-whatsapp"></i></a>
...
<section class="description" id="description">
    ...
    <br>
        ...
        <div class="box1" id="job">
            ...
            <i class="fa-solid fa-user-plus"></i>3 Openings  </a>
            ...
            <div class="job-description">
                ...
                <p>A Front Office Executive, also known as a Front Desk Executive or Receptionist, is responsible for managing the front office of an organization or establishment. They are the first point of contact for visitors, clients, and employees, and play a crucial role in creating a positive and professional impression.</p><br>
                <br>
                <br>
            </div>
            <div class="qualification">
                ...
                <br>
                <ul>
                    <li>Passed 12th board exams with a minimum of 50% aggregate</li>
                    <li>10, +2 exam or an equivalent degree with at least 85% from a recognized institute.</li>
                </ul>
            </div><br><br>
            <div class="skills">
                <h2>Skills:</h2>
                <br>
                <ul>
                    <li>Communication and interpersonal skills to interact with patients effectively.</li>
                    <li>Proficiency in using office software, such as Microsoft Office Suite,email communication, document preparation, and data entry.</li>
                    <li>Effectively managing time</li>
                </ul>  
            </div>        
...
<div class="job-list">
    ...
    <div class="table3" style="width: 65%;">
    <h2 class="job-title">Dental Nurse</h2>
      ...
      <a href="nurse.php" class="btnb">Apply Now </a>
    </div>
