    ...
    <!-- Show Job Description start -->
        <div class="box1" id="job">
            ...
            <div class="about">
                ...
                <i class="fa-solid fa-user-plus"></i>1 Openings  </a>
            ...
            <div class="job-description">
                ...
                <p>A General Dentist is a primary oral healthcare provider, responsible for promoting and maintaining oral health and addressing a wide range of dental issues. Their comprehensive services contribute to the overall well-being of patients.</p><br>
                <br>
                <br>
            </div>
            ...
            <div class="skills">
                ...
                <br>
                <ul>
                    <li>The ability to perform dental procedures, such as fillings, crowns, and root canals.</li>
                    <li>Clear and effective communication is crucial for explaining diagnoses, treatment options, and post-operative care instructions to patients.</li>
                    <li>The ability to use dental equipment and materials safely and effectively.</li>
                </ul>  
            </div>        
        </div>
        <!-- Show Job Description ends -->
